      ...
      <main className="min-h-screen bg-white">
        ...
        <section className="relative min-h-[70vh] flex items-center justify-center overflow-hidden">
          ...
          <div className="container-custom relative z-10 text-center text-white px-4">
            ...
            {hero.subHeading && (
              <p className="text-xl md:text-2xl lg:text-3xl text-gray-200 max-w-3xl mx-auto mb-6 md:mb-8">
                {hero.subHeading}
              </p>
            )}
            {hero.ctaText && hero.ctaURL && (
              <a
                href={hero.ctaURL}
                className="inline-block bg-white text-blue-600 px-8 md:px-10 py-3 md:py-4 rounded-full font-semibold text-lg hover:bg-gray-100 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
              >
                {hero.ctaText}
              </a>
            )}
        ...
        {/* ========== ABOUT SECTION ========== */}
        {about.title && (
          <section className="py-16 md:py-10 bg-gray-50">
        ...
        {gallery.length > 0 && (
          <section className="py-16 md:py-10 bg-gray-50">
            <div className="container-custom">
              <div className="text-center mb-12">
                <span className="text-blue-600 font-semibold text-sm uppercase tracking-wider">Gallery</span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-gray-900 mt-2">
                  Our Gallery
                </h2>
                <p className="text-gray-600 mt-4 max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6">
                {gallery.map((item: any) => (
                  <div
                    key={item._id}
                    className="group relative aspect-square overflow-hidden rounded-xl shadow-lg hover:shadow-2xl transition-shadow"
                  >
                    <img
                      src={item.image}
                    ...
                    {item.altText && (
                      <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center p-4">
                        <p className="text-white text-sm font-medium text-center">{item.altText}</p>
                      </div>
                    )}
                  </div>
                ))}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                  ...
                  {contact.email && (
                    <div className="text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                      ...
                      <p className="text-gray-600 mt-1 break-all">{contact.email}</p>
                    </div>
                  )}
                  ...
                  {contact.address && (
                    <div className="text-center p-6 bg-white rounded-2xl shadow-lg border border-gray-100 hover:shadow-xl transition-shadow">
                      ...
                      <p className="text-gray-600 mt-1 whitespace-pre-line">{contact.address}</p>
                    </div>
                  )}
                </div>
          ...
          <div className="container-custom">
            <div className="flex flex-col md:flex-row items-center justify-between gap-4">
              <div className="text-center md:text-left">
                <h3 className="text-xl font-bold">SEO Dashboard</h3>
